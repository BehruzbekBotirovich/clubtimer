...
<template>
    ...
    <a-modal v-model:open="open" title="Basic Modal" :footer="false" width="1000px">
    ...
    <div class="space-y-4">
        ...
        <div v-for="el in data" :key="el.id"
            ...
            <div class="flex items-center gap-4">
                <a-avatar size="large" :src="el.img" />
                <div>
            ...
            <!-- Details -->
            <div class="flex flex-1 items-center justify-evenly text-center">
                <div>
                ...
                <div>
                    <div class="text-xs text-gray-400 text-left">Phone Number</div>
            ...
            <!-- Actions -->
            <button class="bg-gray-100 p-2 rounded-lg" @click="showModal(el.id)">
